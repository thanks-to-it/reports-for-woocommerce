...
class Alg_WC_Reports_Countries {
	...
	function get_country_continent( $country ) {
		$data = array(
			__( 'North America', 'reports-for-woocommerce' ) => array(
				'CA',
				'MX',
				'US',
			),
			__( 'Europe', 'reports-for-woocommerce' ) => array(
				'AD',
				'AL',
				'AT',
				'AX',
			...
			__( 'Asia', 'reports-for-woocommerce' ) => array(
				'AE',
				'AF',
				'AM',
				'AP',
			...
			__( 'Australia & Oceania', 'reports-for-woocommerce' ) => array(
				'AS',
				'AU',
				'CK',
				'FJ',
			...
			__( 'Central America', 'reports-for-woocommerce' ) => array(
				'AG',
				'AI',
				'AN',
				'AW',
			...
			__( 'South America', 'reports-for-woocommerce' ) => array(
				'AR',
				'BO',
				'BR',
				'CL',
			...
			__( 'Africa', 'reports-for-woocommerce' ) => array(
				'AO',
				'BF',
				'BI',
				'BJ',
